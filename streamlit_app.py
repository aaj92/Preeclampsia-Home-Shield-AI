...
# --------------------------------------------------------
# ISOLATED MULTI-LINE TEXT STRINGS (PREVENTS SYNTAX ERRORS)
# --------------------------------------------------------
EN_ACT_TXT = """1. **GET TO A HOSPITAL IMMEDIATELY:** Do not wait. Leave the house right away. Preeclampsia is a fast-acting emergency.
...
EN_CLI_TXT = """* **Antihypertensive Administration:** Prepare safe emergency blood pressure medications (e.g., oral Labetalol or Nifedipine) if systolic is >= 160 or diastolic is >= 110.
...
EN_MAN_TXT = """### How to Use the At-Home Kit in Displacement Settings
...
FR_ACT_TXT = """1. **RENDEZ-VOUS IMMÉDIATEMENT À L'HÔPITAL :** N'attendez pas. Partez tout de suite. La prééclampsie est une urgence à évolution rapide.
...
FR_CLI_TXT = """* **Administration d'Antihypertenseurs :** Préparer des médicaments sûrs pour la tension artérielle d'urgence (ex. Labétalol oral ou Nifédipine) si la systolique est >= 160 ou la diastolique est >= 110.
...
FR_SUCC_TXT = """**Actions Suivantes :**
* Tout semble normal ce matin.
* **Répétez ce test demain milieu de matinée** exactement à la même heure.
...
FR_MAN_TXT = """### Comment Utiliser le Kit à Domicile en Contexte de Crise
...
3. **Le Déclencheur de Malaise :** La prééclampsie ne se soucie pas des horaires. Si une mère dit *'Je me sens bizarre'* ou se plaint d'un mal de tête, sa famille doit immédiatement lancer cette application."""
